 ...
 * </ul> 
 **/
public class CatalogJsGuiLauncher {

    private static final Logger log = LoggerFactory.getLogger(CatalogJsGuiLauncher.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        CatalogRestApiLauncher.main(args);
    }
    ...
    public static Server startJavascriptAndRest() throws Exception {
        return CatalogRestApiLauncher.startRestResourcesViaFilter( CatalogRestApiLauncher.newTestContentServerConfig() );
    }
...
//        context.addFilter(AllowOriginHeaderFilter.class, "/*", EnumSet.allOf(DispatcherType.class));
